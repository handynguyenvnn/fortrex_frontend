...
import {activeAccount, withdrawConfirmEmail} from "services";
...
const ActiveAccountSuccess = () => {
  ...
  const [message, setMessage] = useState('ACTIVE ACCOUNT SUCCESSFULLY');
  useEffect(() => {
  ...
  return (
    <div className="login">
      <div className="login-inner">
        ...
        <a className="btn success" onClick={onClickLogin}>LOGIN</a>
      </div>
    </div>
  );
};
