...
import {
  ...
  agencyHistory,
  getProfile,
  getNetworkdTradingSnapshot,
} from "services";
import { Input, Spin } from "antd";
import "./style.scss";
import { openNotificationWithIcon } from "utils/utils";
import {
  useNetworkTradingHistoryStore,
  useNetworkAgencyHistoryStore,
} from "store";
import TableCustom from "components/TableCustom/TableCustom";
import NetworksNotAgency from "components/Modal/NetworksNotAgency";
import moment from "moment";
import {
  DATE_FORMATTER_STRING,
  SHORT_DATE_FORMATTER_STRING,
...
const Network = () => {
  const [
    tradingHistoryStore,
    updateTradingHistoryStore,
  ] = useNetworkTradingHistoryStore();
  const [
    agencyHistoryStore,
    updateAgencyHistoryStore,
  ] = useNetworkAgencyHistoryStore();
  ...
  const renderTableNetWorkdTradingSnapshot = () => {
    return (
      dataDatable.length > 0 &&
      dataDatable.map((item, index) => {
        const { Token, Vol, Com } = item;
        return (
          <tr key={Token}>
            <td>
              <img
                height={18}
                width={18}
                src={"https://static.fortrex.io/images/" + Token + ".png?v=1"}
              />
  ...
  useEffect(() => {
    updateTradingHistoryStore((draft) => {
      draft.isReloadTable = true;
    });
    updateAgencyHistoryStore((draft) => {
      draft.isReloadTable = true;
    });
  }, []);
  ...
  const agencyHistoryColumn = [
    {
      ...
      align: "left",
      render: (text) =>
        text ? moment(text).format(DATE_FORMATTER_STRING) : "",
    },
    {
      title: "UserName",
      dataIndex: "username",
  ...
  return (
    <div>
      ...
      />
      <div className="four-icon-wrapper">
            ...
            <li>
              <div className="box-item">
                ...
                <div className="box-text">
                  <h3 className="title">Network Agency Vol.</h3>
                  <div className="price">${statistic.AgencyVol}</div>
                </div>
              </div>
            </li>
            <li>
              <div className="box-item">
                  ...
                  >
                    <g filter="url(#filter0_d)">
                      ...
                      <g clip-path="url(#clip0)">
                        <path
                          d="M33.7969 41.6602V39.3164H36.1406V29.8633H33.7969V27.5195H31.4531V29.8633H29.1094V39.3164H31.4531V41.6602H33.7969Z"
                          fill="#EB5757"
                        />
                        <path
                          d="M52.5469 41.6602V39.3164H54.9688L54.8906 20.4883H52.5469V18.1445H50.2031V20.4883H47.8594V39.3164H50.2031V41.6602H52.5469Z"
                          fill="#EB5757"
                        />
                        <path
                          d="M43.1719 41.6602V39.3164H45.5156V25.1758H43.1719V22.832H40.8281V25.1758H38.4844V39.3164H40.8281V41.6602H43.1719Z"
                          fill="#EB5757"
                        />
                        <path
                ...
                <div className="box-text">
                  <h3 className="title">Agency Com.</h3>
                  <p className="price">${statistic.AgencyCom}</p>
                </div>
              </div>
            </li>
            <li>
              <div className="box-item">
                <div className="icon">
                  ...
                  >
                    <g filter="url(#filter0_d)">
                      ...
                      />
                      <path
                        d="M29.1094 41.5156V39.1719H31.4531V29.7969H29.1094V27.4531H26.7656V29.7969H24.4219V39.1719H26.7656V41.5156H29.1094Z"
                        fill="#FFC329"
                      />
                      <path
                        d="M38.4844 36.8281V34.4844H40.8281V25.1094H38.4844V22.7656H36.1406V25.1094H33.7969V34.4844H36.1406V36.8281H38.4844Z"
                        fill="#FFC329"
                      />
                      <path
                        d="M47.8594 34.4844V32.1406H50.2031V22.7656H47.8594V20.4219H45.5156V22.7656H43.1719V32.1406H45.5156V34.4844H47.8594Z"
                        fill="#FFC329"
                      />
                      <path
                        d="M57.2344 18H54.8906V20.3438H52.5469V29.7969H54.8906V32.1406H57.2344V29.7969H59.5781V20.3438H57.2344V18Z"
                        fill="#FFC329"
                      />
                      <path
                ...
                <div className="box-text">
                  <h3 className="title">Team Daily Trade</h3>
                  <p className="price">${statistic.TeamDailyTrade}</p>
                </div>
              </div>
            </li>
            <li>
              <div className="box-item">
                ...
                <div className="box-text">
                  <h3 className="title">Network Member</h3>
                  <p className="price">{statistic.NetworkMember}</p>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div className="dashboard-top">
        <div className="content-left dashboard-full">
                  ...
                  value={
                    hideReferral
                      ...
                      : window.location.origin +
                        `/register?referral=${statistic.ReferralCode}`
                  }
                />
              </div>
          ...
          <div className="order">
            <div className="title">
              <h3 className="ttl">Network Trading Snapshot</h3>
            </div>
            <div className="table">
              <table>
                <tr>
                ...
                {renderTableNetWorkdTradingSnapshot()}
              </table>
            </div>
          </div>
        </div>
      ...
      <div className="dashboard-bottom">
        <div className="title">
          <h3 className="ttl">Network Member</h3>
        </div>
        <div className="box-search">
          <div className="box-input">
            <input
              type="text"
              className="f-control f-input f-agile-input color-white"
        ...
        <TableCustom
          useStore={useNetworkAgencyHistoryStore}
          columns={menberNetworkColumn}
          apiGetList={agencyHistory}
        />
        </div>
      <div className="dashboard-bottom">
        <div className="title">
          <h3 className="ttl">Agency Com. History</h3>
        </div>
        <div className="box-search">
          <div className="box-input">
            <input
        ...
        <TableCustom
          useStore={useNetworkAgencyHistoryStore}
          columns={agencyHistoryColumn}
          apiGetList={agencyHistory}
        />
      </div>
      <div className="dashboard-bottom">
        <div className="title">
          <h3 className="ttl">Trading Com. History</h3>
        </div>
        <div className="box-search">
          <div className="box-input">
            <input
        ...
        <TableCustom
          useStore={useNetworkTradingHistoryStore}
          columns={tradingHistoryColumn}
          apiGetList={tradingHistory}
        />
      </div>
    </div>
  );
